...
class RulesetPrompt(BaseChatPromptTemplate, BaseModel):
    ...
    def construct_full_prompt(self) -> str:
        ...
        new_ruleset_request = f"{ruleset_request}\n\nPlease update the ruleset by incorporating the following feedback, providing only the ruleset without any additional text so it can easily be copy pasted:\n\n{self.user_feedback}\n"
